...
export default {
  ...
  methods: {
    ...
    createCatalog() {
      ...
      var catalogContainerEl = document.createElement('div')
      catalogContainerEl.innerHTML = '<h2><a href="https://github.com/lfyfly/vue-validate-easy">vue-validate-easy(github)<a/></h2>'
      ...
      document.body.insertBefore(catalogContainerEl, document.querySelector('#app'))
    }
  },
  mounted() {
    ...
    // 自动生成markdown目录
    this.createTitle('#app>h1', 1)
    this.createTitle('#app>h2', 2)
    this.createTitle('#app>h3', 3)
    var catalogEl = document.querySelector('#catalog')
    if (catalogEl) document.body.removeChild(catalogEl)
